...
public class AccountDeletionService {
    ...
    public void deleteAccount(User user, AccountDeletionRequest request) {
        ...
        log.info("Đang xóa tài khoản cho người dùng: {}", user.getUsername());
        ...
        if (request.isExportData()) {
            ...
            log.info("Xuất dữ liệu cho người dùng: {}", user.getUsername());
        }
        ...
        try {
            ...
            log.info("Đã xóa tài khoản thành công cho: {}", user.getUsername());
        } catch (Exception e) {
    ...
    private void blacklistUserTokens(User user) {
        ...
        log.info("Vô hiệu hóa tất cả token cho người dùng: {}", user.getUsername());
    }
