...
@AllArgsConstructor
@NoArgsConstructor
public class PTPackageCreateRequest {
    
    @NotBlank(message = "Tên gói PT không được để trống")
    ...
    @NotNull(message = "Số buổi tập không được để trống")
    ...
    @NotNull(message = "Giá gói PT không được để trống")
