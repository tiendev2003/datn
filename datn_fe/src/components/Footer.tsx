      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="text-2xl font-bold text-white">
              GYM<span className="text-primary">MASTER</span>
            </Link>
            <p className="mt-4 text-gray-400">
              Chúng tôi cung cấp môi trường tập luyện chuyên nghiệp với trang thiết bị hiện đại và đội ngũ huấn luyện viên tận tâm.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/packages" className="text-gray-400 hover:text-primary transition-colors duration-300">
                  Gói tập
                </Link>
              </li>
              <li>
                <Link href="/trainers" className="text-gray-400 hover:text-primary transition-colors duration-300">
                  Huấn luyện viên
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/pricing" className="text-gray-400 hover:text-primary transition-colors duration-300">
                  Bảng giá
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/faq" className="text-gray-400 hover:text-primary transition-colors duration-300">
                  Câu hỏi thường gặp
                </Link>
              </li>
              <li>
                <Link href="/career" className="text-gray-400 hover:text-primary transition-colors duration-300">
                  Cơ hội việc làm
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Đăng ký để nhận tin tức và ưu đãi mới nhất từ chúng tôi.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} GYMMASTER. Tất cả quyền được bảo lưu.
          </p>
