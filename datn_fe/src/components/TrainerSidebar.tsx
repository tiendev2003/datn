  ...
  return (
    <div className="w-full md:w-64 bg-white shadow-md rounded-lg p-4">
      ...
      <nav className="flex flex-col space-y-2">
        ...
        <NavLink href="/account/trainer/schedule" label="Lịch PT" icon={<RiCalendarEventLine size={20} />} />        <NavLink href="/account/trainer/clients" label="Khách hàng" icon={<RiUserLine size={20} />} />
