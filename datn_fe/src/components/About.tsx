      ...
      <div className="container mx-auto px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <h3 className="text-2xl font-semibold mb-4">Phòng tập hiện đại, chất lượng hàng đầu</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                >
                  <span className="text-primary text-4xl font-bold">{item.number}</span>
          ...
          >
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="absolute -bottom-6 -right-6 w-40 h-40 bg-primary/80 rounded-lg flex items-center justify-center p-4"
            >
