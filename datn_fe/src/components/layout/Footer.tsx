        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Transforming lives through fitness excellence and personalized training experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#memberships" className="text-gray-400 hover:text-primary transition-colors">Memberships</Link></li>
              <li><Link href="#trainers" className="text-gray-400 hover:text-primary transition-colors">Trainers</Link></li>
