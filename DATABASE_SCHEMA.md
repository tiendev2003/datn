...
| processed_by    | INT                                            | FOREIGN KEY (users.user_id)           | Family member who processed the check-in |
| notes           | TEXT                                           |                                       | Additional notes                         |
...
- `attendance_logs`: Indexes on `user_id`, `check_in_time`
...
4. `member_attendance_view`: Shows attendance patterns by member
